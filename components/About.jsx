...
export default function About() {
  ...
  return (
    <div className="bg-white font-sans md:px-20 pb-10">
      <div className="container mx-auto p-6">
        ...
        >
          ...
          >
            ...
            <p className="text-gray-600 mb-6 lg:text-[19px]">Founded recently but grounded in deep industry insight, we balance quality, reliability, and cost-effectiveness to bridge the gap between healthcare facilities and the finest medical instruments globally.</p>
          </div>
          <div
