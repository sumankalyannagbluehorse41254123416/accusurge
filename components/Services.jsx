    ...
    <div className="container mx-auto px-12 relative z-10">
      <div className="bg-white rounded-lg shadow-[0_0_25px_rgba(99,149,189,0.1)] pt-12 pb-8 pl-9 pr-16 -mt-32">
        <div className="flex flex-wrap -mx-4">
          {/* Service Box 1: Free Shipping */}
          <div className="w-full lg:w-3/12 md:w-6/12 px-4 mb-8">
            <div className="ps-service-box text-center cursor-pointer">
              <div className="ps-service-icon w-20 h-20 bg-orange-50 rounded-full flex items-center justify-center mx-auto mb-8 transition-all duration-500 ps-service-icon-shipping">
                <span>
                  <svg viewBox="0 0 28 20" width={28} height={20}>
                    <path id="Shape 11" className="shp0" d="M24.68 16.36C24.68 18.37 23.09 20 21.15 20C19.2 20 17.62 18.37 17.62 16.36
